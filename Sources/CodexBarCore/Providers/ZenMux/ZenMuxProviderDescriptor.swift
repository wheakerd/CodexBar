...
public enum ZenMuxProviderDescriptor {
    ...
    public static let spec = PluginProviderSpec(
        id: .zenmux, displayName: "ZenMux", sessionLabel: "5-hour quota", weeklyLabel: "Weekly quota",
        ...
        presentation: ProviderUsagePresentation(
            ...
            menuCard: ProviderMenuCardPresentation(
                primaryDescriptionPlacement: .detailLeft, hidesPrimaryResetWithoutDate: true)),
        aliases: ["zen-mux"], timeout: 35,
