...
public enum ClinePassProviderDescriptor {
    ...
    public static let spec = PluginProviderSpec(
        id: .clinepass, displayName: "ClinePass",
        sessionLabel: "5-hour", weeklyLabel: "Weekly", opusLabel: "Monthly",
        ...
        color: .init(red: 0.38, green: 0.64, blue: 0.98), confetti: [0x61A3FA, 0x111111, 0xFFFFFF],
        noDataMessage: "ClinePass cost history is not available via the usage-limits API.",
        environmentKey: "CLINE_API_KEY", environmentAliases: ["CLINEPASS_API_KEY"],
        ...
        showsAPIDetail: true, requiresCredentialForAvailability: true)
}
